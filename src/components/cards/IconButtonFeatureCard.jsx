export default function IconButtonFeatureCard(props) {
  ...
  return (
    <div
      className={`w-[250px] phone2:w-[300px] phone3:w-[350px] tablet1:h-[200px] desktop1:h-[250px] tablet1:max-w-[255px] desktop1:max-w-[180px] p-0 flex flex-col items-center desktop1:p-0 ${className}`}
    >
      <div
